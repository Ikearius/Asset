 ...
 */
export declare type ConditionCallback<DataT> = (data: DataT) => void;
/**
...
/**
 * Provide an interface to all of the types associated with each namespace in the sdk through a single MpSdk interface
 * ```
 * import { MpSdk } from '@sdk/types';
 *
...
export declare namespace MpSdk {
	export { App, Camera, Conversion, Floor, Label, Mattertag, Measurements, Mode, Model, OAuth, Pointer, Renderer, Room, Scene, Sensor, Settings, Sweep, Tour, };
}
/**
...
export declare type ShowcaseBundleWindow = Window & typeof globalThis & {
	MP_SDK: {
		connect(target: Window, options?: Partial<ConnectOptions>): Promise<MpSdk>;
	};
};
